...
import FreshDashboard from "../Doctors/FreshDashboard"
...
const patientData = {
  ...
  aiInsights: {
    analysis:
      "Based on your 'Blood Chemistry Profile' from Oct 12, your glucose levels are within the optimal range. However, your Vitamin D levels are slightly lower than the recommended 30 ng/mL.",
    suggestions: [
    ...
    warning:
      "Your Blood Pressure (120/80) is perfect. No immediate action required.",
  },
};
...
export default function PatientDashboardMain() {
  ...
  console.log("patient dashboard user:", user);
   useEffect(() => {
    const fetchAppointments = async () => {
      await dispatch(getAllAppointmentsAction());
    };
      fetchAppointments();
  ...
  return (
    <div className="min-h-screen flex font-sans text-slate-800">
      <>
          {
            user && user.isVerified && <FreshDashboard user={user} /> 
          }
          </>
      <div className="max-w-6xl mx-auto space-y-6">
         ...
         <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 rounded-2xl text-white shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-extrabold mb-3 tracking-tight">Good morning, {user?.name}! 👋</h1>
       ...
       { <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 rounded-2xl p-6 text-white shadow-xl flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
          <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-xl font-bold flex items-center justify-center md:justify-start">
                AI Health Insight
                <span className="ml-2 text-[10px] bg-white/20 px-2 py-1 rounded-full border border-white/30 uppercase tracking-widest">
                  Live Analysis
                </span>
              </h2>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mt-2 text-sm font-medium text-slate-700">
                      <span className="flex items-center gap-1 bg-slate-100 px-2 py-1 rounded-md">
                        <Calendar className="h-4 w-4 text-slate-500" /> Mar 15,
                        2026
                      </span>
                      <span className="flex items-center gap-1 bg-slate-100 px-2 py-1 rounded-md">
      ...
      <div className="flex items-center gap-6">
        <div className="w-32 hidden sm:block">
          <div className="flex justify-between text-xs mb-1">
            ...
            <span
              className={
                needsRefill ? "text-red-500 font-bold" : "text-slate-400"
              }
            >
